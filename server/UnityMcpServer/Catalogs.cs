...
{
    private static readonly object ProjectPathProperty = Schema.String("Optional Unity project path. Required when multiple Unity Bridges are reachable.");

    private static Dictionary<string, object> WithProjectPath(Dictionary<string, object>? properties = null)
    {
    ...
    [
        new
        {
            ...
            inputSchema = Schema.Object(WithProjectPath())
        },
        new
        {
            name = "unity_health",
        ...
        new
        {
            ...
            inputSchema = Schema.Object(WithProjectPath(new Dictionary<string, object>
            {
                ["projectPath"] = Schema.String("Optional Unity project path to compile. When provided, the running bridge must be connected to this project; otherwise batchmode compile is used."),
